            ...
            <div class="col-lg-3  col-md-12">
                <div class="single-footer-widget mail-chimp">
                    ...
                    <ul class="instafeed d-flex flex-wrap">
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i1.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i2.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i3.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i4.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i5.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i6.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i7.jpg')}}" alt=""></li>
                        <li><img src="{{asset('front/'.env('TEMPLATE_NAME').'/img/i8.jpg')}}" alt=""></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script src="{{asset('front/'.env('TEMPLATE_NAME').'/js/jquery.ajaxchimp.min.js')}}"></script>
